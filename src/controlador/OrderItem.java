...
public String GetItemPrecioU(String orderItem){ 
String[] delimitado=orderItem.split(""+temp); 
return delimitado[2]; 
} 
...
public String GeneraItem(String cantidad, String nombre,String precioU,String precio){return cantidad+temp[0]+nombre+temp[0]+precioU+temp[0]+precio;} 
} 
